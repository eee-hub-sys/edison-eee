...
const CoordinatorCard = ({ member, index }: { member: Coordinator; index: number }) => (
    ...
    >
        <div className="relative aspect-4/5 rounded-xl overflow-hidden mb-4 md:mb-6">
            ...
            />
            <div className="absolute inset-0 bg-linear-to-t from-[#25343F] via-transparent to-transparent opacity-60" />
        ...
        <div className="px-3 md:px-4 pb-3 md:pb-4 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between text-[9px] md:text-[10px] font-bold text-text-muted border-b border-white/5 pb-2 gap-2">
